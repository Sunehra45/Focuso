'use client'
import { Clock, BarChart2, Award, User } from "lucide-react";
...
export default function Sidebar({children}:any) {
  ...
  const menuItems = [
    ...
    { name: "Streaks", icon: Award, link: "/streak" },
 ...
 const pathname = usePathname();
  ...
  return (
    ...
    <div className="w-full h-18 gap-8 md:gap-3  flex absolute bottom-0 md:w-20 md:h-screen  md:flex-col items-center justify-center md:py-4 md:space-y-4 ">
